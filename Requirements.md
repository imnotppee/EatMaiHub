...
| FR-7 | รายงานปัญหา/เสนอแก้ข้อมูล            | ผู้ใช้แจ้งข้อมูลร้านที่ไม่ถูกต้อง หรือรายงานรีวิวที่ไม่เหมาะสมเพื่อให้ผู้ดูแลตรวจสอบ |
| FR-8 | เส้นทาง/การเดินทาง                   | ระบบลิงก์เปิด Google Maps หรือ Apple Maps พร้อมตำแหน่งร้าน เพื่อแสดงเส้นทางให้ผู้ใช้ |
| FR-9 | Audit Log                            | ระบบบันทึกประวัติการแก้ไขข้อมูลร้าน เมนู และการลบรีวิว เพื่อการตรวจสอบย้อนหลัง       |
